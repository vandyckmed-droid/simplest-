...
| Built | Not built yet |
| --- | --- |
| iPhone-first layout with safe-area handling | A universe beyond 50 names |
...
replays the draw. Opening now takes 630ms.
...
- Every holding count from 1 to 50 displays weights totalling exactly 100.0%
